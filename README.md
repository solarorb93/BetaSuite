...
3. Create BetaSuite directory
    * There needs to be a folder on your computer where all the BetaSuite files will go.  Create a folder somewhere on your computer to hold it.  This location needs to have at least 1GB of free space available,and more if you’re analyzing very large videos.  It can be anything: C:\BetaSuite\, D:\my_private_folder\censortools\, C:\My Documents\Faxes\Archived\2017\, whatever.  
...
6. Download BetaSuite
    * Download BetaSuite v0.1.1 from this link: https://mega.nz/file/cv4DnYgb#mkfbcIZL19sTfsO6qqQXRz-zCsSRiPgQtBmYvHIAeC8 
